...
class init_args:
    def __init__(self):
        ...
        self.attr_dim = 312
        self.nz = 312    # the same dimensionality as the class embedding
        self.n_class_all = 200
        self.n_class_seen = 150
        self.syn_num = 300
        self.ood_train_syn_num = 5
        self.batch_size = 256   # for sample
        self.test_batch_size = 256   # for sample
        ...
        # share paremeter
        self.manualSeed = 2356
        self.cuda = True
        self.validation = False
        self.preprocessing = True
        self.standardization = False
        self.lr = 0.0001
        self.dependent_lr = 0.0001
        ...
        self.bi_loss_para = 0  # 0.0001

        self.kl_loss_para = 0  # 0.0001
